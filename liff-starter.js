        ...
        if (tipe === 'fotext') {
            liff.sendMessages([{
                ...
                sentBy: {
                    ...
                    linkUrl: "line://app/1602936534-pXKe8X51?type=fotext&text="+encodeURI(teks)}
            }]).then(function () {
                liff.closeWindow();
            });
        }
        ...
        if (tipe === 'foimage') {
            liff.sendMessages([{
                ...
                sentBy: {
                    label: prof.displayName,
                    iconUrl: prof.pictureUrl,
                    linkUrl: "line://app/1602936534-pXKe8X51?type=foimage&img="+getParameterByName('img')}
            }]).then(function () {
                liff.closeWindow();
            });
        }
                    ...
                    actions: [
                        {
                            type:"uri",
                            label:"Me",
                            uri:"line://app/1602936534-pXKe8X51?type=template"
                        }
                    ]
                }
            }]).then(function () {
            ...
            liff.sendMessages([{
                ...
                contents: {
                      ...
                      hero: {
                        ...
                        action: {
                          type: "uri",
                          uri: "line://app/1602936534-pXKe8X51?type=foimage&img="+pict
                        }
                      },
                      body: {
                        type: "box",
                        ...
                        contents: [
                          {
                            ...
                            action: {
                              type: "uri",
                              label: "IG",
                              uri: "https://instagram.com/rahmatagung8"
                            },
                            flex: 1
                          },
                          {
                            ...
                            action: {
                              type: "uri",
                              label: "Me",
                              uri: "line://app/1602936534-pXKe8X51?type=me"
                            },
                            flex: 2
                          },
                          {
